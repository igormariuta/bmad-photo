      ...
      {tabs.map((tab, index) => {
        ...
        return (
          <button
            ...
            className={`-mb-0.5 cursor-pointer border-b-2 py-3 text-eyebrow uppercase transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent ${
